<style>
    img.w-10.h-10 {display: flex;justify-self: center;}
</style>

<div class="flex justify-center my-10 md:my-24">
    <div class="w-4/5 md:w-2/3 bg-white grid grid-rows-7 p-3 md:p-7 rounded-xl shadow-md">
        <div class="grid row-span-1 justify-center text-4xl font-bold mb-3">
            <p>Kompetencer</p>
        </div>
        <div class="grid row-span-6 justify-center mt-4 md:grid-cols-4 gap-5">
            <div class="grid justify-center w-full col-span-1">
